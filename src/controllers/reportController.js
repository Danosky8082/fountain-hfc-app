  ...
  try {
    ...
    if (submitter?.email) {
      ...
      const result = await sendReportEmail({
        ...
        html: `<h2>Your Report Has Been Finalized</h2>...`,
        pdfBuffer,
        filename: `HFC_Report_${updated.fellowship.name}_${updated.monthYear}.pdf`,
      });
      if (result.success) {
